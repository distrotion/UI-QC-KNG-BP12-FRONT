...
abstract class DSA01_Event {}

class DSA01_READ extends DSA01_Event {}

class DSA01_Bloc extends Bloc<DSA01_Event, DSA01SCHEMA> {
  DSA01_Bloc()
      : super(DSA01SCHEMA(
          ItemPick: [''],
  ...
  Future<void> _DSA01_READ(DSA01SCHEMA toAdd, Emitter<DSA01SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "DSA01db",
      data: {},
    );
    DSA01SCHEMA output = DSA01SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
