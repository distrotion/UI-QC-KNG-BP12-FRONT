...
abstract class GASHMVKNG003_Event {}

class GASHMVKNG003_READ extends GASHMVKNG003_Event {}

class GASHMVKNG003_Bloc extends Bloc<GASHMVKNG003_Event, GASHMVKNG003SCHEMA> {
  GASHMVKNG003_Bloc()
      : super(GASHMVKNG003SCHEMA(
          ItemPick: [''],
    ...
    on<GASHMVKNG003_READ>((event, emit) {
      return _GASHMVKNG003_READ(
          GASHMVKNG003SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _GASHMVKNG003_READ(
      GASHMVKNG003SCHEMA toAdd, Emitter<GASHMVKNG003SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "GASHMVKNG003db",
      data: {},
    );
    GASHMVKNG003SCHEMA output = GASHMVKNG003SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
