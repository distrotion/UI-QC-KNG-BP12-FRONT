...
abstract class GASHMVKNG001_Event {}

class GASHMVKNG001_READ extends GASHMVKNG001_Event {}

class GASHMVKNG001_Bloc extends Bloc<GASHMVKNG001_Event, GASHMVKNG001SCHEMA> {
  GASHMVKNG001_Bloc()
      : super(GASHMVKNG001SCHEMA(
          ItemPick: [''],
    ...
    on<GASHMVKNG001_READ>((event, emit) {
      return _GASHMVKNG001_READ(
          GASHMVKNG001SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _GASHMVKNG001_READ(
      GASHMVKNG001SCHEMA toAdd, Emitter<GASHMVKNG001SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "GASHMVKNG001db",
      data: {},
    );
    GASHMVKNG001SCHEMA output = GASHMVKNG001SCHEMA(
      Pic: "",
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
