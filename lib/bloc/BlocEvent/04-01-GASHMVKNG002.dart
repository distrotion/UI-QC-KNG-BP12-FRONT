...
abstract class GASHMVKNG002_Event {}

class GASHMVKNG002_READ extends GASHMVKNG002_Event {}

class GASHMVKNG002_Bloc extends Bloc<GASHMVKNG002_Event, GASHMVKNG002SCHEMA> {
  GASHMVKNG002_Bloc()
      : super(GASHMVKNG002SCHEMA(
          ItemPick: [''],
    ...
    on<GASHMVKNG002_READ>((event, emit) {
      return _GASHMVKNG002_READ(
          GASHMVKNG002SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _GASHMVKNG002_READ(
      GASHMVKNG002SCHEMA toAdd, Emitter<GASHMVKNG002SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "GASHMVKNG002db",
      data: {},
    );
    GASHMVKNG002SCHEMA output = GASHMVKNG002SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
