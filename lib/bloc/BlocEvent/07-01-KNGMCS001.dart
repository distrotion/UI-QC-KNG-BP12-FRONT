...
abstract class KNGMCS001_Event {}

class KNGMCS001_READ extends KNGMCS001_Event {}

class KNGMCS001_Bloc extends Bloc<KNGMCS001_Event, KNGMCS001SCHEMA> {
  KNGMCS001_Bloc()
      : super(KNGMCS001SCHEMA(
          ItemPick: [''],
    ...
    on<KNGMCS001_READ>((event, emit) {
      return _KNGMCS001_READ(
          KNGMCS001SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _KNGMCS001_READ(
      KNGMCS001SCHEMA toAdd, Emitter<KNGMCS001SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "KNGMCS001db",
      data: {},
    );
    KNGMCS001SCHEMA output = KNGMCS001SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
